...
pub const MANUFACTURER_STR: [u8; 20] = [
    0x12, 0x03, // 22 (length)
    b'O', 0x00, b'z', 0x00, b'S', 0x00, b'e', 0x00, b'c', 0x00, b'C', 0x00, b'o', 0x00, b'n', 0x00,
    b'.', 0x00,
];

pub const PRODUCT_STR: [u8; 18] = [
    0x12, 0x03, // 18 (length)
    b'M', 0x00, b'a', 0x00, b'g', 0x00, b'S', 0x00, b'p', 0x00, b'o', 0x00, b'o', 0x00,b'f',0x00
];
